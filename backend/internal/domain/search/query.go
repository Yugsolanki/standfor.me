...
type MovementSearchRequest struct {
	...
	// Depth of Commitment Verification Filters (optional)
	VerifiedSupporterCount   *int64   `json:"verified_supporter_count" form:"verified_supporters" validate:"omitempty,gte=0"`
	UnverifiedSupporterCount *int64   `json:"unverified_supporter_count" form:"unverified_supporters" validate:"omitempty,gte=0"`
	MinAvgVerificationTier   *float64 `json:"min_avg_verification_tier" form:"min_avg_vt" validate:"omitempty,gte=0,lte=5,ltefield=MaxAvgVerificationTier"`
	MaxAvgVerificationTier   *float64 `json:"max_avg_verification_tier" form:"max_avg_vt" validate:"omitempty,gte=0,lte=5"`
	MinMinVerificationTier   *int     `json:"min_min_verification_tier" form:"min_min_vt" validate:"omitempty,gte=0,lte=5"`
	MinMaxVerificationTier   *int     `json:"min_max_verification_tier" form:"min_max_vt" validate:"omitempty,gte=0,lte=5"`
	MinMaxBadgeLevelNumeric  *int     `json:"min_max_badge_level" form:"min_max_badge" validate:"omitempty,gte=0,lte=5"`
